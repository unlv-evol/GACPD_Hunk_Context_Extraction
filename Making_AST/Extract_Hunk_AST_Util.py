...
def is_hunk_import (source_code, hunk_start_line, hunk_end_line):
    """
    Will return whether the hunk is in the import section of the file (usually at the top). 
    ...
    Returns
    -------
    is_hunk_import:     A boolean that determines whether the hunk is in the import section or not.
...
def get_current_AST_import_declarations(AST):
        """
